...
palb2cams <- c("#657800" "#e86bff" "#84ff99" "#013aab" "#df8700" "#79c7ff" "#ff4557" "#003a05" "#e3d1ff" "#760032" "#9a9a9b")
...
#option2b1 - look at FAMILY eaten among bats grouped by location
#first, reorder:
treemap_df <- treemap_df[with(treemap_df, order(family_name, order_name)), ] 

treemap(treemap_df, 
        index=c("Site", "family_name"),
        vSize="counts",
        vColor="order_name",
        type="categorical",
        title = "Numbers of Family counts per Site colored by taxonomic Order",
        title.legend = "Taxonomic Order",
        position.legend = "right",
        align.labels=list(c("center", "top"), c("left", "bottom")), 
        fontsize.labels=c(14,6),
...
#option2b2 - look at FAMILY eaten among bats grouped by BatSpecies
  #note this aggregates all information for Bat Species across all sites!
#first, reorder:
treemap_df <- treemap_df[with(treemap_df, order(family_name, order_name)), ] 

treemap(treemap_df, 
        index=c("BatSpecies", "family_name"),
        vSize="counts",
        vColor="order_name",
        type="categorical",
        title = "Numbers of Family counts per Bat Species colored by taxonomic Order",
        title.legend = "Taxonomic Order",
        position.legend = "right",
        align.labels=list(c("center", "top"), c("left", "bottom")), 
        fontsize.labels=c(14,6),
